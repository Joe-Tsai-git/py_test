...
group1 = nr.filter(filter_func=lambda host: host.name=='PE1')
...
out = group1.run(netmiko_send_command, command_string='disp bgp vpnv4 vpn-inst ABC rou', use_textfsm=True)
print_result(out)
